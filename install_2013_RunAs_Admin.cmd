...
cls
echo[
echo Choose your desired Office 365 (2013) installation:
echo ---------------------------------------------------
echo[
...
cls
echo[
echo OFFICE 365 PROPLUS (2013) ONLY
echo[
...
cls
echo[
echo OFFICE 365 PROPLUS (2013) WITH PROJECT
echo[
echo Installing Office 365 ProPlus...
%~dp0\SOURCES\ProPlus\setup.exe /configure "%~dp0\SOURCES\ProPlus\install.xml" > NUL
echo Done!
...
cls
echo[
echo OFFICE 365 PROPLUS (2013) WITH VISIO
echo[
echo Installing Office 365 ProPlus...
%~dp0\SOURCES\ProPlus\setup.exe /configure "%~dp0\SOURCES\ProPlus\install.xml" > NUL
echo Done!
...
cls
echo[
echo OFFICE 365 PROPLUS (2013) WITH PROJECT AND VISIO
echo[
echo Installing Office 365 ProPlus...
%~dp0\SOURCES\ProPlus\setup.exe /configure "%~dp0\SOURCES\ProPlus\install.xml" > NUL
echo Done!
...
cls 
echo[
echo OFFICE 365 BUSINESS (2013) ONLY
echo[
...
cls
echo[
echo OFFICE 365 BUSINESS (2013) WITH PROJECT
echo[
echo Installing Office 365 Business...
%~dp0\SOURCES\Business\setup.exe /configure "%~dp0\SOURCES\Business\install.xml" > NUL
echo Done!
...
cls 
echo[
echo OFFICE 365 BUSINESS (2013) WITH VISIO
echo[
echo Installing Office 365 Business...
%~dp0\SOURCES\Business\setup.exe /configure "%~dp0\SOURCES\Business\install.xml" > NUL
echo Done!
...
cls  
echo[
echo OFFICE 365 BUSINESS (2013) WITH PROJECT AND VISIO
echo[
echo Installing Office 365 Business...
%~dp0\SOURCES\Business\setup.exe /configure "%~dp0\SOURCES\Business\install.xml" > NUL
echo Done!
...
cls 
echo[
echo OFFICE 365 SMALL BUSINESS (2013) ONLY
echo[
...
cls
echo[
echo OFFICE 365 SMALL BUSINESS (2013) WITH PROJECT
echo[
echo Installing Office 365 Small Business...
%~dp0\SOURCES\SmallBusiness\setup.exe /configure "%~dp0\SOURCES\SmallBusiness\install.xml" > NUL
echo Done!
...
cls
echo[
echo OFFICE 365 SMALL BUSINESS (2013) WITH VISIO
echo[
echo Installing Office 365 Small Business...
%~dp0\SOURCES\SmallBusiness\setup.exe /configure "%~dp0\SOURCES\SmallBusiness\install.xml" > NUL
echo Done!
...
cls
echo[
echo OFFICE 365 SMALL BUSINESS (2013) WITH PROJECT AND VISIO
echo[
echo Installing Office 365 Small Business...
%~dp0\SOURCES\SmallBusiness\setup.exe /configure "%~dp0\SOURCES\SmallBusiness\install.xml" > NUL
echo Done!
...
cls
echo[
echo You have selected Skype for Business 2015 / Lync 2013
echo[
echo Which version do you need?
echo ---------------------------------------------------------
echo[
echo 1. Skype for Business Basic / Lync Basic 2013
echo 2. Skype for Business / Lync 2013
...
echo[
echo Installing Skype for Business Basic 2015 / Lync Basic 2013
%~dp0\SOURCES\SkypeBusiness_Basic\setup.exe /configure "%~dp0\SOURCES\SkypeBusiness_Basic\install.xml"
echo Done!
timeout /t 5 /nobreak > NUL
goto check_Skype
...
echo SKYPE FOR BUSINESS BASIC / LYNCBASIC
echo[
echo Installing Skype for Business 2015 / Lync 2013
%~dp0\SOURCES\SkypeBusiness\setup.exe /configure "%~dp0\SOURCES\SkypeBusiness\install.xml"
echo Done!
timeout /t 5 /nobreak > NUL
goto check_Skype
...
:check_Office
IF EXIST "C:\Program Files\Microsoft Office 15\root\office15\OUTLOOK.EXE" (
    goto finish_success
) ELSE (
    goto finish_fail
)
...
:check_Skype
IF EXIST "C:\Program Files\Microsoft Office 15\root\office15\lync.exe" (
    goto finish_success
) ELSE (
    goto finish_fail
)
...
:check_Project
IF EXIST "C:\Program Files\Microsoft Office 15\root\office15\WINPROJ.EXE" (
    goto finish_success
) ELSE (
    goto finish_fail
)
...
:check_Visio
IF EXIST "C:\Program Files\Microsoft Office 15\root\office15\VISIO.EXE" (
    goto finish_success
) ELSE (
    goto finish_fail
)
